...
public class Example {
  ...
  protected static final ConfigKey CONF_TEXT_IN_DATA = Config.registerValues("main.state.in.data",
      "Accepting new data from provider");
  protected static final ConfigKey CONF_DATA_PROVIDER = Config.registerValues("main.dataprovider",
  ...
  // 2. get ouput module
  final AwtListener listener = new AwtListener(perspective, MAIN.getGraphics(),
      MAIN.getGraphicsConfiguration());
  // 3. init data bridge for perspective
  private final PriorityDataReceiver dataReceiver = new PriorityDataReceiver(perspective,
      new CreateLayersCallback() {
    ...
    MAIN.addMouseListener(new MouseAdapter() {
      ...
      public void mouseReleased(final MouseEvent e) {
        if (e.getButton() == MouseEvent.BUTTON1 && dragStart != null) {
          canvasAdapter.moveBy((int) (dragStart[2] - e.getX()), (int) (dragStart[3] - e.getY())
              * -1);
          dragStart = null;
        }
      }
