...
public class MoveUtils {
     ...
     * configuration
     */
    public static final Config CONF_MOVE_SCALE = Cfg.register("perspective.move.scale", Double.valueOf(0.05d));
    public static final Config CONF_ZOOM_SCALE = Cfg.register("perspective.zoom.scale", Double.valueOf(0.2d));
    /**
     * reference to canvas
     */
    ...
    public void move(final double x, final double y, final double z) {
        final double move = Cfg.doublet(CONF_MOVE_SCALE).doubleValue();
        final double zoom = Cfg.doublet(CONF_ZOOM_SCALE).doubleValue();
